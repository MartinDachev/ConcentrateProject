Public Class MediumLevel
    ...
    'array(12) and array2(12) are arrays which are generating textboxes
    Dim array(12) As TextBox
    Dim array2(12) As TextBox
    ...
    End Sub
    Sub CreateTextBox()
        'Creating textboxes and setting their location from array(12)
        Dim horizontal As Integer = 40
        Dim vertical As Integer = 40
        Dim p As Integer
        For p = 1 To 12 Step 1
            array(p) = New TextBox
    ...
    End Sub
    Sub CreateTextBox2()
        'Creating textboxes and setting their location from array2(12)
    ...
    Private Sub RandomNumbers_Tick(sender As Object, e As EventArgs) Handles RandomNumbers.Tick
        'Setting values to the textboxes from array(12)
        Tick = True
    ...
    Private Sub RememberTimer_Tick(sender As Object, e As EventArgs) Handles RememberTimer.Tick
        'Hiding the array(12) textboxes and showing array2(14) textboxes
        Dim Count As Integer
        For Count = 1 To 12 Step 1
    ...
    Private Sub ReadyButton_Click_1(sender As Object, e As EventArgs) Handles ReadyButton.Click
        'Comparing the answers with the values from the textboxes from array(12)
        Dim Check1 As Integer
        For Check1 = 1 To 12 Step 1
