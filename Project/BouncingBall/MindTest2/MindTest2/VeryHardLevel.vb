Public Class VeryHardLevel
    ...
    'array(16) and array2(16) are arrays which are generating textboxes
    Dim array(16) As TextBox
    Dim array2(16) As TextBox
    ...
    End Sub
    Sub CreateTextBox()
        'Creating textboxes and setting their location from array(16)
        ...
        For p = 1 To 16 Step 1
            ...
            End If
            Controls.Add(array(8))
            Controls.Add(array(16))
        Next
    End Sub
    Sub CreateTextBox2()
        'Creating textboxes and setting their location from array2(16)
        ...
        For p = 1 To 16 Step 1
            ...
            End If
            Controls.Add(array2(8))
            Controls.Add(array2(16))
        Next
    End Sub
    ...
    Private Sub RandomNumbers_Tick(sender As Object, e As EventArgs) Handles RandomNumbers.Tick
        'Setting values to the textboxes from array(16)
        Tick = True
    ...
    Private Sub RememberTimer_Tick(sender As Object, e As EventArgs) Handles RememberTimer.Tick
        'Hiding the array(16) textboxes and showing array2(16) textboxes
        Dim Count As Integer
        For Count = 1 To 16 Step 1
    ...
    Private Sub ReadyButton_Click_1(sender As Object, e As EventArgs) Handles ReadyButton.Click
        'Comparing the answers with the values from the textboxes from array(16)
        Dim Check1 As Integer
        For Check1 = 1 To 16 Step 1
        ...
        DatabaseContent.UpdateDatabase.AddMindTest2MediumScore(gameScore)
    End Sub
